...
- [ ] UI bug/enhancement - Setting for "Keep episodes" and "Auto-delete played episodes" are confusing. What happens if "Keep episodes" is set to "all episodes", what does "Auto-delete played episodes" do? Shouldn't it do nothing and disappear or be disabled? This is confusing.
